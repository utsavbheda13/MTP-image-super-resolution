...
def getParameters():
    ...
    # general settings
    parser.add_argument('-v', '--version', type=str, default='imageSR_X2_DIV2K',
    ...
    parser.add_argument('-s', '--checkpoint_epoch', type=int, default=5,
    ...
    parser.add_argument('--test_dataset_name', type=str, default='Urban100', 
                choices=['B100', 'Urban100', 'Set5', 'Set14', "Manga109"])
