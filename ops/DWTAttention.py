...
class DWTAttention(nn.Module):
    def __init__(self,num_in_ch=3, num_feat=64, bias = True, **kwargs):
        ...
        self.cross_attention1 = CrossAttention(num_in_ch, num_feat)
    ...
    def forward(self, x):
        ...
        hllhhh_ca = self.cross_attention1(HL,LH,HH)

        low_high_ca = self.cross_attention2(osag_out,hllhhh_ca,hllhhh_ca)
